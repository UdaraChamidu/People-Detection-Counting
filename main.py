...
area1 = np.array([[506, 436], [371, 254], [588, 191], [744, 220]])
area2 = np.array([[1078, 213], [1398, 191], [1527, 267], [1525, 539]])
...
while True:
    ...
    cv2.putText(frame, '1', (510, 465), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 2)
    cv2.putText(frame, '2', (510, 555), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 2)
    ...
    for bbox in bbox_id:
        ...
        # Check if in Area 2 (and was in Area 1)
    ...
    # Display counters
    cv2.putText(frame, f'Entering: {len(entering)}', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
